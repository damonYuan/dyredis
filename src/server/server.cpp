...
namespace dyr {
    ...
    static bool try_one_request(Conn *conn) {
        ...
        // Q: Why not just empty the buffer? See the explanation of
        // "pipelining".
        return true;  // success
    }
    ...
    int Server::start() {
        ...
        // Host to Network Short,  “Host” means the CPU
        // endian. “Network” means big-endian.
        addr.sin_port = htons(1234);
        // Host to Network Long, wildcard address 0.0.0.0
        addr.sin_addr.s_addr = htonl(0);
        // struct sockaddr_in and struct
        // sockaddr_in6 have different sizes, so
        // the struct size (addrlen) is needed.
        ...
        // listen
        // the size of the queue. SOMAXCONN is 4096 on Linux.
        // The socket is actually created after listen(). The OS will
        // automatically handle TCP handshakes and place established connections
        // in a queue. The application can then retrieve them via accept().
        ...
        while (true) {
            ...
            poll_args.push_back(listening_pfd);
